...
WebUI.setText(findTestObject('Page_nopCommerce demo store. Shopping Cart/input_Qty._itemquantity11220'), total_item_updated)

WebUI.click(findTestObject('Page_nopCommerce demo store. Shopping Cart/button_Update shopping cart'))
