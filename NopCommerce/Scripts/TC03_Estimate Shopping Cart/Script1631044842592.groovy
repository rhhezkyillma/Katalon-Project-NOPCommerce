...
WebUI.click(findTestObject('Page_nopCommerce demo store. Shopping Cart/a_Estimate shipping'))

WebUI.selectOptionByLabel(findTestObject('Page_nopCommerce demo store. Shopping Cart/select_Select country'), select_country, 
    false)

WebUI.selectOptionByLabel(findTestObject('Page_nopCommerce demo store. Shopping Cart/select_Other'), other, false)

WebUI.setText(findTestObject('Page_nopCommerce demo store. Shopping Cart/input__ZipPostalCode'), postal_code)

if (shipping_method.equals('Ground')) {
    WebUI.click(findTestObject('Page_nopCommerce demo store. Shopping Cart/radioButton1'))
} else if (shipping_method.equals('Next Day Air')) {
    WebUI.click(findTestObject('Page_nopCommerce demo store. Shopping Cart/radioButton2'))
} else {
    WebUI.click(findTestObject('Page_nopCommerce demo store. Shopping Cart/radioButton3'))
}

'Captured Screenshoot'
CustomKeywords.'com.nopcommerce.PublicKeyword.TakeScreenshot'('Shopping Cart')

WebUI.click(findTestObject('Page_nopCommerce demo store. Shopping Cart/button_Apply'))
